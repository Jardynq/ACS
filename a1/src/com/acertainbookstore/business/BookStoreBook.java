...
public class BookStoreBook extends ImmutableBook {
     ...
     *
     * @param numTimesRated the new number of times rated
     */
     ...
     *
     * @param numSaleMisses the new sale misses
     */
     ...
     *
     * @param editorPick the new editor pick
     */
     ...
     *
     * @param numNewCopies the number of new copies
     */
     ...
     *
     * @param numSaleMisses the number of sales misses encountered
     */
    ...
    public ImmutableBook immutableBook() {
        return new ImmutableBook(this.getISBN(), this.getTitle(), this.getAuthor(),
                this.getPrice());
    }
    ...
    public StockBook immutableStockBook() {
        return new ImmutableStockBook(this.getISBN(), this.getTitle(), this.getAuthor(),
    ...
    public BookStoreBook copy() {
        return new BookStoreBook(this.getISBN(), this.getTitle(), this.getAuthor(),
