...
public interface BookStore {
     ...
     *
     * @param booksToBuy the books to buy
     * @throws BookStoreException the book store exception
     */
    void buyBooks(Set<BookCopy> booksToBuy) throws BookStoreException;
     ...
     * @throws BookStoreException the book store exception
     */
    void rateBooks(Set<BookRating> bookRating) throws BookStoreException;
     ...
     * @throws BookStoreException the book store exception
     */
    List<Book> getBooks(Set<Integer> ISBNList) throws BookStoreException;
     ...
     * @throws BookStoreException the book store exception
     */
    List<Book> getTopRatedBooks(int numBooks) throws BookStoreException;
     ...
     * @throws BookStoreException the book store exception
     */
    List<Book> getEditorPicks(int numBooks) throws BookStoreException;
}
