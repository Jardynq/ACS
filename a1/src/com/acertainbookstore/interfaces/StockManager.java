...
public interface StockManager {
     ...
     *
     * @param bookSet the book set
     * @throws BookStoreException the book store exception
     */
    void addBooks(Set<StockBook> bookSet) throws BookStoreException;

    /**
     * Adds copies of the existing books to the bookstore.
     *
     * @param bookCopiesSet the book copies set
     * @throws BookStoreException the book store exception
     */
    void addCopies(Set<BookCopy> bookCopiesSet) throws BookStoreException;
     ...
     * @throws BookStoreException the book store exception
     */
    List<StockBook> getBooks() throws BookStoreException;
     ...
     * @throws BookStoreException the book store exception
     */
    List<StockBook> getBooksByISBN(Set<Integer> isbns) throws BookStoreException;
     ...
     * @throws BookStoreException the book store exception
     */
    List<StockBook> getBooksInDemand() throws BookStoreException;

    /**
     * Updates the books by mark/unmark them as editor pick.
     *
     * @param editorPicks the editor picks
     * @throws BookStoreException the book store exception
     */
    void updateEditorPicks(Set<BookEditorPick> editorPicks) throws BookStoreException;
     ...
     * @throws BookStoreException the book store exception
     */
    void removeAllBooks() throws BookStoreException;

    /**
     * Cleans up the bookstore selectively for the list of provided ISBNs.
     *
     * @param isbnSet the ISBN set
     * @throws BookStoreException the book store exception
     */
    void removeBooks(Set<Integer> isbnSet) throws BookStoreException;
}